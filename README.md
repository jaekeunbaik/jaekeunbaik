...
📈 ERP · HR · CRM · CTI 시스템 개발 경험 다수

🚀 What I'm Working On

사이드 프로젝트 진행 중이며, React, Go, Python 등 새로운 기술을 꾸준히 탐구하고 있어요.

Java Spring, JSP, Vue 기반의 백엔드·프론트엔드 개발을 병행하고 있습니다.

ERP, HR, CRM, CTI 시스템 개발 및 운영 경험을 바탕으로 실무 중심의 문제 해결을 하고 있습니다.

📚 Learning & Exploring

새로운 기술 트렌드를 계속해서 공부하며 스택을 확장 중입니다.

최근에는 React, Go, Python, EAI 연동 구조 개선 등에 깊은 관심을 갖고 있습니다.

💬 Ask Me About

Java Spring / JSP / Vue 관련 개발

ERP·HR 시스템 아키텍처 및 최적화
...
현재 부동산 사기 예방 사이트를 직접 개발 중입니다.

기술로 사회적 임팩트를 만드는 데 관심이 많아요.

다양한 것을 즐기며, 늘 웃으면서 개발하는 타입입니다. 😄
